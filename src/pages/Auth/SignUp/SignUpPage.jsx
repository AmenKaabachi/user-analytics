    ...
    <div className={styles.authPage}>
      <Container>
        <Row className={styles.authWrapper}>
          <Col md={7} className="d-none d-md-block"> {/* Adjust the first column size */}
            <img src={signupImage} alt="Sign Up" className={styles.signupImage} />
          </Col>
          <Col md={5}> {/* Adjust the second column size */}
